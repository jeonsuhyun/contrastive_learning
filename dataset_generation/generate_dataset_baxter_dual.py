...
parser.add_argument('--exp_name', type=str, default='baxter', help='panda_orientation, panda_dual, panda_dual_orientation')
...
def set_constraint():
    ...
    def set_constraint_by_condition(condition):
        ...
        # pc.detach_object('tray', 'left_hand')
        ...
        q = np.zeros(14)
        pos, quat = constraint.forward_kinematics('R_arm', q[:7])
        ...
        pc.update_joints(q)
        pc.attach_object('tray', 'right_hand', [])
