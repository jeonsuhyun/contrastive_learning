...
class LinearModel(nn.Module):
    def __init__(self, input_dim=7, feature_dim=128, num_clusters=10):
        ...
        self.cluster_layer = nn.Linear(feature_dim, num_clusters)
...
def get_resnet(name):
    ...
    resnet1D = ResNet1D(block=BasicBlock, layers=[2, 2, 2, 2])
    linear = LinearModel()
    resnets = {
        "ResNet18": resnet18,
        "ResNet34": resnet34,
