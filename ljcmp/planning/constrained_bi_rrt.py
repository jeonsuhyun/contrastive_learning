...
class ConstrainedBiRRT:
    def __init__(self, state_dim=3, constraint: ConstraintBase = None, validity_fn=None, start_region_fn=None, goal_region_fn=None) -> None:
        ...
        # properties
        self.max_distance = 0.32
        # self.delta = 0.2 * self.max_distance
        self.delta_ratio = 0.25
        self.delta = 0.2
        # self.delta = 0.05
    ...
    def is_valid(self,q):
        # TODO: collision detection net will be added here.
        # q = self.learned_model.to_state(q)
        ...
        # if np.linalg.norm(self.constraint.function(q)) < 0.2:
        return r
        # return False
        # return True
    ...
    def discrete_geodesic(self, start, end, validity_check_in_interpolation = True):
        ...
        while True:
            ...
            dist = new_dist
            previous = scratch
            # previous = copy.deepcopy(scratch)
    ...
    def solve(self, max_time=10.0):
        self.delta = self.delta_ratio * self.max_distance
        ...
        while terminate is False: # TODO: time condition ?
            ...
            if r != GrowStatus.TRAPPED:
                ...
                if r == GrowStatus.REACHED:
                    ...
                    # print(q_path)
                    # q_path = np.array([self.learned_model.to_state(q) for q in q_path])
                    # print(q_path)

                    # scipy.io.savemat('planned_path.mat', {'q_path': q_path, 'q_path': q_path})
                    return True, q_path
    ...
    def interpolate(self, q_from, q_to, ratio):
        ...
        if status != GrowStatus.REACHED:
            # self.print('interpolation failed')
            return q_from, False
    ...
    def geodesic_interpolate(self, geodesic, ratio):
        ...
        # return self.interpolate(geodesic[i-1], geodesic[i], t1)
