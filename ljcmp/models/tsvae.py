...
class TSVAE(torch.nn.Module, LatentModel):
    ...
    def __init__(self, x_dim=0, z_dim=0, c_dim=0, 
        ...
        # print('encoder_layer_size: {}'.format(encoder_layer_size))
        # print('decoder_layer_size: {}'.format(decoder_layer_size))
        # print('beta: {}'.format(beta))
        # print('gamma: {}'.format(gamma))
        # print('max_capacity: {}'.format(max_capacity))
        # print('C_stop_iter: {}'.format(C_stop_iter))
        # print('warmup_stop_iter: {}'.format(warmup_stop_iter))
        # print('activation: {}'.format(activation))
        # print('null_augment: {}'.format(null_augment))
        # print('sample_size: {}'.format(sample_size))
        # print('var: {}'.format(var))
        # print('kl_loss_type: {}'.format(kl_loss_type))
        # print('===============================')
